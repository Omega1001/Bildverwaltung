...
CREATE TABLE bildverwaltung.PICTURE (ID VARCHAR(36) NOT NULL, COMMENT LONGVARCHAR, CREATIONDATE TIMESTAMP NOT NULL, EXTENSION VARCHAR NOT NULL, HEIGTH INTEGER NOT NULL, LASTUPDATE TIMESTAMP NOT NULL, NAME VARCHAR NOT NULL, URI VARCHAR NOT NULL, WIDTH INTEGER NOT NULL, PRIMARY KEY (ID));
